...
export default function EmergencyContacts ({route}) {
    ...
    const defaultMessage = `Give me all the necessary emergency contacts in ${route.params.country} as a list and do not include any other sentences as a response outside of the list`;
