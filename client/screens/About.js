    ...
    <View style={tw`bg-white flex flex-1 px-3`}>
      ...
      <View>
        ...
        <View>
          ...
          <Text style={tw`text-sm font-regular mt-3`}>
            {/* App Description */}
            Refugee Assister is a mobile application designed to provide essential support and resources for refugees and displaced individuals. Our mission is to empower refugees by offering tools, information, and assistance in their journey towards stability and self-sufficiency.
          </Text>
        </View>
        {/* Acknowledgments */}
        <View>
          ...
          <Text style={tw`text-sm font-regular mt-3`}>
            ...
            We'd like to acknowledge the open-source libraries and resources that have contributed to this app. Their support has been invaluable in our mission to assist refugees.
          </Text>
        </View>
      </View>
    </View>
