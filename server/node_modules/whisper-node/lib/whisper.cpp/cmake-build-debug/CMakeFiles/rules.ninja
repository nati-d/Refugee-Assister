...
rule C_COMPILER__whisper_Debug
  depfile = $DEP_FILE
  deps = gcc
...
rule CXX_COMPILER__whisper_Debug
  depfile = $DEP_FILE
  deps = gcc
...
rule CXX_SHARED_LIBRARY_LINKER__whisper_Debug
...
rule CXX_COMPILER__bench_Debug
  depfile = $DEP_FILE
  deps = gcc
  command = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++ $DEFINES $INCLUDES $FLAGS -MD -MT $out -MF $DEP_FILE -o $out -c $in
  description = Building CXX object $out
...
rule CXX_EXECUTABLE_LINKER__bench_Debug
  command = $PRE_LINK && /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++ $FLAGS -Wl,-search_paths_first -Wl,-headerpad_max_install_names $LINK_FLAGS $in -o $TARGET_FILE $LINK_PATH $LINK_LIBRARIES && $POST_BUILD
  description = Linking CXX executable $TARGET_FILE
  restat = $RESTAT
...
rule RERUN_CMAKE
  command = /Applications/CLion.app/Contents/bin/cmake/mac/bin/cmake --regenerate-during-build -S/Users/ari/Developer/Projects/whisper-node/lib/whisper.cpp -B/Users/ari/Developer/Projects/whisper-node/lib/whisper.cpp/cmake-build-debug
